 ...
 * @param lng
 */
export async function getWGBTFromLatLng(lat: number, lng: number): Promise<WBGTResponse> {
 ...
 * @param lng
 */
export async function getAirTempFromLatLng(lat: number, lng: number): Promise<AirTempResponse> {
